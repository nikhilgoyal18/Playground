...
def main():
    ...
    initial_state = {
        ...
        "faithfulness_grounded_claims": None,
        "faithfulness_total_claims": None,
        "faithfulness_ungrounded": None,
    ...
    try:
        ...
        log = {
            ...
            "faithfulness_grounded_claims": final_state.get("faithfulness_grounded_claims"),
            "faithfulness_total_claims": final_state.get("faithfulness_total_claims"),
            "faithfulness_ungrounded": final_state.get("faithfulness_ungrounded"),
            "faithfulness_judge_skipped": final_state.get("faithfulness_judge_skipped", False),
